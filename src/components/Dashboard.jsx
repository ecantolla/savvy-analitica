...
export default function Dashboard() {
  ...
  const tabs = [
    ...
    { id: 4, label: "Medios de Pago",          image: "vista5-medio-pago.webp",          desc: "Analiza cómo te pagan tus clientes. Verifica comisiones de Transbank, conoce las propinas del día y sabrás exactamente cuánto efectivo debe haber en caja al día siguiente." },
